//! Gömülü Hüma kaynak envanteri.
//!
//! Kütüphane API'leri henüz kararlı değildir; bu paket yalnız kaynakların
//! runtime ve araçlardan bağımsız bir sınırda taşınmasını sağlar.
